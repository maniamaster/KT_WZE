...
\documentclass{Vorlage/MFPREPORT}
...
\input{Vorlage/layout.tex}

\begin{document}
%Autor, etc.
\newcommand{\versuch}{FM.TES}
\newcommand{\titel}{Tunneleffekt bei Supraleitern}
\newcommand{\praktikantA}{Eric Bertok}
\newcommand{\praktikantB}{Jan Weinreich}
\newcommand{\betreuer}{?????}
\newcommand{\emailA}{
...
\newcommand{\durchfuehrungsdatum}{25.02.2017}
...
\begin{titlepage}
\centering
\textsc{\Large Master-Forschungspraktikum
  ,\\[1.5ex] Schwerpunkt Festkörper- und Materialphysik (M.phy.403)}
